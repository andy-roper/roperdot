...
regexp=\s(\d+),\s+(\d+)\s
colours=default,"\033[38;5;222m","\033[38;5;179m"
=======
# Date-Time => G1=Month G2=Day G3=Hour G4=Minutes G5=Year
regexp=([A-Z][a-z]{2})\s([ 1-3]\d)\s(?:([0-2]?\d):([0-5]\d)(?=[\s,]|$)|\s*(\d{4}))
colours=unchanged,"\033[38;5;31m","\033[38;5;31m","\033[38;5;31m","\033[38;5;31m","\033[01;38;5;182m"
=======
# root
regexp=\s(root|wheel)(?=\s|$)
colours=unchanged,"\033[01;38;5;250;48;5;167m"
=======
# SELinux
regexp=(\w+_u):(\w+_r):(\w+_t):(\w\d)
colours=default,"\033[38;5;143m","\033[38;5;179m","\033[38;5;31m","\033[38;5;182m"
-
# -rwxrwxrwx ============================
# File Type
regexp=(-|([bcCdDlMnpPs?]))(?=[-r][-w][-xsStT][-r][-w][-xsStT][-r][-w][-xsStT])
colours=unchanged,unchanged,"\033[01;38;5;250m"
-
# owner rwx
regexp=(?<=[-bcCdDlMnpPs?])(-|(r))(-|(w))(-|([xsStT]))(?=[-r][-w][-xsStT][-r][-w][-xsStT])
colours=unchanged,unchanged,"\033[38;5;192m",unchanged,"\033[38;5;192m",unchanged,"\033[38;5;192m"
-
# group rwx
regexp=(?<=[-bcCdDlMnpPs?][-r][-w][-xsStT])(-|(r))(-|(w))(-|([xsStT]))(?=[-r][-w][-xsStT])
...
colours=unchanged,"\033[01;38;5;143m","\033[01;38;5;179m","\033[01;38;5;167m"
-
# ACL
regexp=^\S{10}(\+)
colours=unchanged,"\033[01;38;5;250;48;5;31m"
=======
# Date-Time long-iso
regexp=(\d{4})-(\d\d)-(\d\d) (\d\d):(\d\d)
colours="\033[38;5;31m","\033[38;5;31m","\033[38;5;31m","\033[38;5;31m","\033[38;5;31m"
