...
regexp=\s(\d+),\s+(\d+)\s
colours=default,"\033[38;5;222m","\033[38;5;215m"
=======
# Date-Time => G1=Month G2=Day G3=Hour G4=Minutes G5=Year
regexp=([A-Z][a-z]{2})\s([ 1-3]\d)\s(?:([0-2]?\d):([0-5]\d)(?=[\s,]|$)|\s*(\d{4}))
colours=unchanged,"\033[38;5;37m","\033[38;5;37m","\033[38;5;37m","\033[38;5;37m","\033[01;38;5;168m"
=======
# root
regexp=\s(root|wheel)(?=\s|$)
colours=unchanged,"\033[01;38;5;248;48;5;203m"
=======
# SELinux
regexp=(\w+_u):(\w+_r):(\w+_t):(\w\d)
colours=default,"\033[38;5;71m","\033[38;5;215m","\033[38;5;37m","\033[38;5;168m"
-
# -rwxrwxrwx ============================
# File Type
regexp=(-|([bcCdDlMnpPs?]))(?=[-r][-w][-xsStT][-r][-w][-xsStT][-r][-w][-xsStT])
colours=unchanged,unchanged,"\033[01;38;5;248m"
-
# owner rwx
regexp=(?<=[-bcCdDlMnpPs?])(-|(r))(-|(w))(-|([xsStT]))(?=[-r][-w][-xsStT][-r][-w][-xsStT])
colours=unchanged,unchanged,"\033[38;5;149m",unchanged,"\033[38;5;149m",unchanged,"\033[38;5;149m"
-
# group rwx
regexp=(?<=[-bcCdDlMnpPs?][-r][-w][-xsStT])(-|(r))(-|(w))(-|([xsStT]))(?=[-r][-w][-xsStT])
colours=unchanged,unchanged,"\033[38;5;215m",unchanged,"\033[38;5;215m",unchanged,"\033[38;5;215m"
-
# other rwx
regexp=(?<=[-bcCdDlMnpPs?][-r][-w][-xsStT][-r][-w][-xsStT])(-|(r))(-|(w))(-|([xsStT]))
...
colours=unchanged,"\033[01;38;5;71m","\033[01;38;5;215m","\033[01;38;5;203m"
-
# ACL
regexp=^\S{10}(\+)
colours=unchanged,"\033[01;38;5;248;48;5;37m"
=======
# Date-Time long-iso
