...
regexp=\s(\d+),\s+(\d+)\s
colours=default,"\033[38;5;220m","\033[38;5;214m"
=======
# Date-Time => G1=Month G2=Day G3=Hour G4=Minutes G5=Year
regexp=([A-Z][a-z]{2})\s([ 1-3]\d)\s(?:([0-2]?\d):([0-5]\d)(?=[\s,]|$)|\s*(\d{4}))
colours=unchanged,"\033[38;5;36m","\033[38;5;36m","\033[38;5;36m","\033[38;5;36m","\033[01;38;5;133m"
=======
# root
regexp=\s(root|wheel)(?=\s|$)
colours=unchanged,"\033[01;38;5;188;48;5;167m"
=======
# SELinux
regexp=(\w+_u):(\w+_r):(\w+_t):(\w\d)
colours=default,"\033[38;5;35m","\033[38;5;214m","\033[38;5;36m","\033[38;5;133m"
-
# -rwxrwxrwx ============================
# File Type
...
# owner rwx
regexp=(?<=[-bcCdDlMnpPs?])(-|(r))(-|(w))(-|([xsStT]))(?=[-r][-w][-xsStT][-r][-w][-xsStT])
colours=unchanged,unchanged,"\033[38;5;78m",unchanged,"\033[38;5;78m",unchanged,"\033[38;5;78m"
-
# group rwx
regexp=(?<=[-bcCdDlMnpPs?][-r][-w][-xsStT])(-|(r))(-|(w))(-|([xsStT]))(?=[-r][-w][-xsStT])
colours=unchanged,unchanged,"\033[38;5;214m",unchanged,"\033[38;5;214m",unchanged,"\033[38;5;214m"
-
# other rwx
regexp=(?<=[-bcCdDlMnpPs?][-r][-w][-xsStT][-r][-w][-xsStT])(-|(r))(-|(w))(-|([xsStT]))
...
colours=unchanged,"\033[01;38;5;35m","\033[01;38;5;214m","\033[01;38;5;167m"
-
# ACL
regexp=^\S{10}(\+)
colours=unchanged,"\033[01;38;5;188;48;5;36m"
=======
# Date-Time long-iso
