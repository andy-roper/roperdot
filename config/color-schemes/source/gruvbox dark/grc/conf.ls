...
regexp=\s(\d+),\s+(\d+)\s
colours=default,"\033[38;5;214m","\033[38;5;172m"
=======
# Date-Time => G1=Month G2=Day G3=Hour G4=Minutes G5=Year
regexp=([A-Z][a-z]{2})\s([ 1-3]\d)\s(?:([0-2]?\d):([0-5]\d)(?=[\s,]|$)|\s*(\d{4}))
colours=unchanged,"\033[38;5;71m","\033[38;5;71m","\033[38;5;71m","\033[38;5;71m","\033[01;38;5;132m"
=======
# root
regexp=\s(root|wheel)(?=\s|$)
colours=unchanged,"\033[01;38;5;138;48;5;160m"
=======
# SELinux
regexp=(\w+_u):(\w+_r):(\w+_t):(\w\d)
colours=default,"\033[38;5;100m","\033[38;5;172m","\033[38;5;71m","\033[38;5;132m"
-
# -rwxrwxrwx ============================
# File Type
regexp=(-|([bcCdDlMnpPs?]))(?=[-r][-w][-xsStT][-r][-w][-xsStT][-r][-w][-xsStT])
colours=unchanged,unchanged,"\033[01;38;5;138m"
-
# owner rwx
regexp=(?<=[-bcCdDlMnpPs?])(-|(r))(-|(w))(-|([xsStT]))(?=[-r][-w][-xsStT][-r][-w][-xsStT])
colours=unchanged,unchanged,"\033[38;5;142m",unchanged,"\033[38;5;142m",unchanged,"\033[38;5;142m"
-
# group rwx
regexp=(?<=[-bcCdDlMnpPs?][-r][-w][-xsStT])(-|(r))(-|(w))(-|([xsStT]))(?=[-r][-w][-xsStT])
colours=unchanged,unchanged,"\033[38;5;172m",unchanged,"\033[38;5;172m",unchanged,"\033[38;5;172m"
-
# other rwx
regexp=(?<=[-bcCdDlMnpPs?][-r][-w][-xsStT][-r][-w][-xsStT])(-|(r))(-|(w))(-|([xsStT]))
...
colours=unchanged,"\033[01;38;5;100m","\033[01;38;5;172m","\033[01;38;5;160m"
-
# ACL
regexp=^\S{10}(\+)
colours=unchanged,"\033[01;38;5;138;48;5;71m"
=======
# Date-Time long-iso
regexp=(\d{4})-(\d\d)-(\d\d) (\d\d):(\d\d)
colours="\033[38;5;71m","\033[38;5;71m","\033[38;5;71m","\033[38;5;71m","\033[38;5;71m"
