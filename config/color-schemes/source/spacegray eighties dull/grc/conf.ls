...
regexp=\s(\d+),\s+(\d+)\s
colours=default,"\033[38;5;221m","\033[38;5;173m"
=======
# Date-Time => G1=Month G2=Day G3=Hour G4=Minutes G5=Year
regexp=([A-Z][a-z]{2})\s([ 1-3]\d)\s(?:([0-2]?\d):([0-5]\d)(?=[\s,]|$)|\s*(\d{4}))
colours=unchanged,"\033[38;5;116m","\033[38;5;116m","\033[38;5;116m","\033[38;5;116m","\033[01;38;5;139m"
=======
# root
regexp=\s(root|wheel)(?=\s|$)
colours=unchanged,"\033[01;38;5;251;48;5;131m"
=======
# SELinux
regexp=(\w+_u):(\w+_r):(\w+_t):(\w\d)
colours=default,"\033[38;5;144m","\033[38;5;173m","\033[38;5;116m","\033[38;5;139m"
-
# -rwxrwxrwx ============================
# File Type
...
# owner rwx
regexp=(?<=[-bcCdDlMnpPs?])(-|(r))(-|(w))(-|([xsStT]))(?=[-r][-w][-xsStT][-r][-w][-xsStT])
colours=unchanged,unchanged,"\033[38;5;114m",unchanged,"\033[38;5;114m",unchanged,"\033[38;5;114m"
-
# group rwx
regexp=(?<=[-bcCdDlMnpPs?][-r][-w][-xsStT])(-|(r))(-|(w))(-|([xsStT]))(?=[-r][-w][-xsStT])
...
colours=unchanged,"\033[01;38;5;144m","\033[01;38;5;173m","\033[01;38;5;131m"
-
# ACL
regexp=^\S{10}(\+)
colours=unchanged,"\033[01;38;5;251;48;5;116m"
=======
# Date-Time long-iso
