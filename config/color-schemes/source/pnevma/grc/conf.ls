...
regexp=\s(\d+),\s+(\d+)\s
colours=default,"\033[38;5;187m","\033[38;5;180m"
=======
# Date-Time => G1=Month G2=Day G3=Hour G4=Minutes G5=Year
regexp=([A-Z][a-z]{2})\s([ 1-3]\d)\s(?:([0-2]?\d):([0-5]\d)(?=[\s,]|$)|\s*(\d{4}))
colours=unchanged,"\033[38;5;115m","\033[38;5;115m","\033[38;5;115m","\033[38;5;115m","\033[01;38;5;182m"
=======
# root
regexp=\s(root|wheel)(?=\s|$)
colours=unchanged,"\033[01;38;5;253;48;5;138m"
=======
# SELinux
regexp=(\w+_u):(\w+_r):(\w+_t):(\w\d)
colours=default,"\033[38;5;144m","\033[38;5;180m","\033[38;5;115m","\033[38;5;182m"
-
# -rwxrwxrwx ============================
# File Type
regexp=(-|([bcCdDlMnpPs?]))(?=[-r][-w][-xsStT][-r][-w][-xsStT][-r][-w][-xsStT])
colours=unchanged,unchanged,"\033[01;38;5;253m"
-
# owner rwx
regexp=(?<=[-bcCdDlMnpPs?])(-|(r))(-|(w))(-|([xsStT]))(?=[-r][-w][-xsStT][-r][-w][-xsStT])
...
# group rwx
regexp=(?<=[-bcCdDlMnpPs?][-r][-w][-xsStT])(-|(r))(-|(w))(-|([xsStT]))(?=[-r][-w][-xsStT])
colours=unchanged,unchanged,"\033[38;5;180m",unchanged,"\033[38;5;180m",unchanged,"\033[38;5;180m"
-
# other rwx
regexp=(?<=[-bcCdDlMnpPs?][-r][-w][-xsStT][-r][-w][-xsStT])(-|(r))(-|(w))(-|([xsStT]))
colours=unchanged,unchanged,"\033[38;5;174m",unchanged,"\033[38;5;174m",unchanged,"\033[38;5;174m"
-
# sStT all
regexp=(?<=[-bcCdDlMnpPs?])[-r][-w]([sStT])[-r][-w]([sStT])[-r][-w]([sStT])
colours=unchanged,"\033[01;38;5;144m","\033[01;38;5;180m","\033[01;38;5;138m"
-
# ACL
regexp=^\S{10}(\+)
colours=unchanged,"\033[01;38;5;253;48;5;115m"
=======
# Date-Time long-iso
regexp=(\d{4})-(\d\d)-(\d\d) (\d\d):(\d\d)
colours="\033[38;5;115m","\033[38;5;115m","\033[38;5;115m","\033[38;5;115m","\033[38;5;115m"
